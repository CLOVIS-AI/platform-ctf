...
class Config(object):
    ...
    def __init__(self):
        ...
        self.VCENTER_HOST = os.environ.get("terraform_vcenter_host")
        self.VCENTER_USER = os.environ.get("terraform_vcenter_user")
        self.VCENTER_PASSWORD = os.environ.get("terraform_vcenter_password")
