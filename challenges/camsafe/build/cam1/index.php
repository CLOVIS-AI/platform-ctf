    ...
    <div style="height: 90%;">
        ...
        <video id="video" title="Wildlife" preload="auto" style="height: 100%;" autoplay muted loop>
            ...
            if ($_SERVER['PHP_AUTH_USER'] === 'admin')
                echo '<source src="http://camsafe:CamSafeM@ster@' . $ip . ':' . $port . '/Cam1/saved/record.webm" type="video/webm">';
            else
                echo '<source src="http://camsafe:CamSafeM@ster@' . $ip . ':' . $port . '/Cam1/record.webm" type="video/webm">';
            ?>
        </video>
    </div>
...
<?php
echo '<script src="http://camsafe:CamSafeM@ster@' . $ip . ':' . $port . '/Cam1/video_controls.js"></script>'
?>
